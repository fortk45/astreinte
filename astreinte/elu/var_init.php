...
if (isset($_REQUEST['folder'])){
	//on vérifie que le dossier dans lequel on cherche est bien partage/[nom du dossier de la malette élus]
	if(substr($_REQUEST['folder'], 0, 12+$nbMalette) == "../partage/".$malette."/"){
