    ...
    <div class="paramAllChoicesAdm">
        <div class="row"> 
            ...
            <div class="paramChoiceAdm col-6">
                <button type="button" class="button1 sendRapport" onclick="ajoutDemandeur(nameNewDemandeur.value)">Envoyer</button>
            </div>
            <div class="paramChoiceAdm col-6">
...
<div class="parameters_block" id="newSujet" style="display: none;">
    ...
    <div class="paramAllChoicesAdm">
        <div class="row"> 
            ...
            <div class="paramChoiceAdm col-6">
                <button type="button" class="button1 sendRapport" onclick="ajoutSujet(nameNewElement.value)">Envoyer</button>
            </div>
            <div class="paramChoiceAdm col-6">
