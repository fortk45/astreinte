...
//récupérer le groupe
$sqlCateg = $connection->prepare("SELECT `categorie` FROM `preferences` WHERE `id_preferences`=:id_pref");
$sqlCateg->bindParam(':id_pref', $newAgent);
$sqlCateg->execute();
$laCateg = $sqlCateg->fetch();
$categSelect = $laCateg['categorie'];
